...
model = dict(
    ...
    bev_w=bev_w_,
    roi_size=roi_size,
    use_llm=False,  # Stage1 does not use LLM
    ...
    lane_head=dict(
        ...
        dn_cfg=dict(
            ...
            num_classes=class_nums,
            noise_scale=dict(label=0.5, box=0.2, pt=0.0),
            group_cfg=dict(dynamic=True, num_groups=1, num_dn_queries=240),
            bev_h=bev_h_,
            bev_w=bev_w_,
            pc_range=point_cloud_range,
            voxel_size=[0.1, 0.1],
