...
# class CustomDistEvalHook(BaseEvalHook):
...
#         from projects.plugin.core.apis.test import custom_multi_gpu_test
...
class CustomDistEvalHook(BaseDistEvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        from projects.plugin.core.apis.test import custom_multi_gpu_test as multi_gpu_test
