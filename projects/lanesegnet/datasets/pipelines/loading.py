...
class LoadAnnotations3DLaneSegment(LoadAnnotations3D):
    ...
    def __init__(self,
                 ...
                 with_label_3d=False,
                 with_area=False,
                 with_future_waypoint=False,
                 with_ego_fut_cmd=False,
                 **kwargs):
        ...
        self.with_future_waypoint = with_future_waypoint
        self.with_ego_fut_cmd = with_ego_fut_cmd
    def _load_lanes_3d(self, results):
        ...
        if self.with_lane_label_3d:
            ...
            results['gt_lane_id'] = results['lane_id']

        if self.with_future_waypoint:
            results['gt_future_waypoint'] = results['ann_info']['gt_future_waypoint']
        
        if self.with_ego_fut_cmd:
    ...
    def __repr__(self):
        ...
        repr_str += f'{indent_str}with_future_waypoint={self.future_waypoint}, '
        repr_str += f'{indent_str}with_ego_fut_cmd={self.with_ego_fut_cmd}, '
        return repr_str
