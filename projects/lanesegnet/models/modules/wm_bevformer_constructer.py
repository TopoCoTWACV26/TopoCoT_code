...
class WMBEVFormerConstructer(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(WMBEVFormerConstructer, self).__init__(**kwargs)
    ...
    def forward(self, bev_queries, img_metas, prev_bev=None, **kwargs):
        """
        obtain bev features.
        """
