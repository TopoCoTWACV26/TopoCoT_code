...
model = dict(
    ...
    train_cfg=dict(
        lane=dict(
            assigner=dict(
                type='LaneSegmentHungarianAssigner3DFrechet',
...
log_level = 'INFO'
work_dir = None
# load_from = '/home/cyx/yym/ANTR-Lanesegnet_family/LaneSegNet-main/work_dirs/lanesegnet/lanesegnet_r50_8x1_24e_olv2_subset_A.pth'
load_from = None
resume_from = None
workflow = [('train', 1)]
